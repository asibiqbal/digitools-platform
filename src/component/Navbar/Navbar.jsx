const Navbar = () => {
  ...
  <ul className="menu menu-horizontal px-1">
    <li>
      {/* First menu item: Always bold, no hover change needed */}
      <a className="font-bold bg-transparent active:bg-transparent target:bg-transparent">
        Products
      </a>
    </li>
    <li>

      <a className="transition-all duration-200 hover:font-bold bg-transparent hover:bg-transparent active:bg-transparent">
        Features
      </a>
    </li>
    <li>
